var questions = [
  {question:"Surgery Gynaecology General"},
  {question:"wtf"},
...
var element = document.getElementByClass("types");
element.classList.add("animated");
element.classList.add("bounceOutRRight");


$('.types').click(function() {
  this.addClass('animated bounceOutRRight');
})
